...
import { Calendar, Clock, AlertTriangle, MessageSquare, Building2, Activity, Radio, BarChart3, ClipboardList, FileText, Megaphone, Upload, Settings } from "lucide-react";
...
const menuItems = [
  ...
  { icon: AlertTriangle, label: "Activos Sin Agendamiento", path: "/pacientes-activos-sin-agendamiento" },
  ...
  { icon: Send, label: "Envío Masivo", path: "/envio-masivo" },
  ...
  { icon: Megaphone, label: "Canal Recordatórios", path: "/canal-recordatorios" },
  ...
  { icon: Upload, label: "Importar Pacientes", path: "/importar-pacientes" },
  { icon: Settings, label: "Configuraciones Clínica", path: "/configuraciones-clinica" },
];
